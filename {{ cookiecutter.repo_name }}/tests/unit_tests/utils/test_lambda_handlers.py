from {{ cookiecutter.src_package_name }}.utils.lambda_handlers import EventHandler
...
def test_event_handler_admin_user(mocker):
    manage = mocker.patch("{{ cookiecutter.src_package_name }}.utils.lambda_handlers.manage")
